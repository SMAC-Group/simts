...
* [hydro](https://rdrr.io/github/SMAC-Group/datapkg/man/hydro.html): Precipitation monthly data from 1907 and going to 1972 for total of 781 observations taken  from Hipel and McLeod (1994)
...
* [Nile](https://stat.ethz.ch/R-manual/R-devel/library/datasets/html/Nile.html): Measurements of the annual flow of the river Nile at Aswan (formerly Assuan), 1871–1970, in $10^8 m^3$ taken from Table 1 of Cobb (1978).
...
```{r, fig.align='center', fig.height = 4, fig.width = 7.25, fig.cap = 'Figure 1: Monthly  precipitation  series  from  1907  to  1972  taken  from Hipel and McLeod (1994)'}
# Load hydro dataset
data("hydro")
...
```{r, fig.align='center', fig.height = 4, fig.width = 7.25, fig.cap = 'Figure 2: Monthly  (seasonally  adjusted)  Personal
Saving  Rates data  from  January  1959  to  May  2015  provided  by  the Federal  Reserve  Bank  of  St.  Louis.'}
