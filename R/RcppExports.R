...
#' @param scale A \code{integer} indicating the amount of decomposition performed at each level. The default value is 10.
#' @return A \code{vector} containing the AR(1) blocks process.
#' @details 
#' This function allows us to generate a non-stationary AR(1) blocks process to understand the behaviors 
#' and properties of non-stationary processes. 
#' @author Yuming Zhang
#' @examples
...
#' from the theoretical MOAV of a stationary AR(1) process. This difference of allan variance between stationary
