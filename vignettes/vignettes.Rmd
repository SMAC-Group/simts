...
model_sunspots = estimate(AR(9), sunspots)
simts::predict(model_sunspots, n.ahead = 10, level = c(0.60, 0.90, 0.95))
```
...
```{r, fig.align='center', fig.height = 4, fig.width = 7.25, fig.cap = 'Figure 16: Plot of Annual Nile river flow from 1871-1970'}
# Load Nile dataset
Nile = datasets::Nile
...
```{r, fig.align='center', fig.height = 4, fig.width = 7.25, fig.cap = 'Figure 17: Empirical autocorrelation function of the Nile river flow data'}
# Compute ACF and plot result
...
```{r, fig.align='center', fig.height = 4, fig.width = 7.25, fig.cap = 'Figure 18: Empirical ACF and PACF of the Nile river flow data'}
# Compute and plot ACF and PACF
...
=======
>>>>>>> ecdbed410d548f818378c6048323920d6bfc4eb9
