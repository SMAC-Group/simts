...
The Time Series Tools (`simts`) R package provides a series of tools to simulate, plot, estimate, select and forecast different time series models based on the basic summary statistics for time series analysis. More specifically, it provides the following features:
