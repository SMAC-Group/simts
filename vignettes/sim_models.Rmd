...
Furthermore, under some minor constraints, all of these models can be combined into a specific class of linear state-space models. As such, we describe how to use `simts` to express this type of model as a sum of basic models. 
