...
In this section, we briefly list, describe, and provide code from the `simts` package that may be useful for creating simulation methods involving time-series data.

Furthermore, under some minor constraints, all of these models can then be combined into a specific class of linear state-space models. As such, we will desribe how to use `simts` to express this type of model as a sum of basic models.
...
The code below shows how to call the function `gen_gts()`, which allows the user to generate samples from the above models.
