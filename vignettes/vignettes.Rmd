...
# Simulate based on data
sales = gts(as.vector(sales), start = 1992, freq = 12, unit_time = "month",
...
```{r, fig.align='center', fig.height = 4, fig.width = 7.25, fig.cap = 'Figure 9: Plot of Annual Nile river flow from 1871-1970'}
# Load Nile dataset
Nile = datasets::Nile
