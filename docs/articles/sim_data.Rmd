...
- Add new dataset
- Remove dependency to `wv` by moving acf code in `simts`.
- Fix title in `plot.ACF()`.
- Add the possibility of computing/plotting the `PACF`.
...
- Remeber that all dependencies to ggplot2 should be removed!
