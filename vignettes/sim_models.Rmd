...
In this section we briefly list, describe and provide the syntax for the methods available for simulation purposes within the simts package. Under some minor constraints, all these models can then be combined into a specific class of linear state-space models which can be represented as a sum of underlying models. Having stated this, some of the basic models available in the `simts` package to simulate from are the following:
